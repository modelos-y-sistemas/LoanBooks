...
class loans{
    ...
    public $librarian;
    //constructor
    public function __construct($id_loan = 0, $book="n/n", $category="n/n", $total=0, $start_order="1000-01-01 00:00:00", $end_order="1000-01-01 00:00:00", $returned=0, $debtor, $librarian){
